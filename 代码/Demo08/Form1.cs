...
namespace Demo08
{
    public partial class Form1 : Form
    {
        ...
        Image[] imgYuan;
        int idx = 0;
        public enum SpecaialEffectType { Cat,Grass};
        ...
        private void PictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                g.DrawImage(imgGrass[idx % 61], 93, 0);
                g.DrawImage(imgYuan[idx % 61], 100, 180);
            }
            /*
            */
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < 61; j++)
            {
                    imgEars[j] = Image.FromFile("res/grass/grass_" +
                        j.ToString("D3") + ".png");//占三位，不足自动补0
                    imgMoustache[j] = Image.FromFile("res/yuan/yuan_" +
                        j.ToString("D3") + ".png");
            }
                timer1.Enabled = true;
        }
